...
if version!='1.3.1': errors.append(f'Unexpected VERSION: {version}')
...
if str(manifest.get('library_version'))!='1.3.1': errors.append('Manifest version mismatch')
...
if len(cases)!=27: errors.append(f'Expected 27 test cases, got {len(cases)}')
