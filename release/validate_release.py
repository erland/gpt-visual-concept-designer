...
if version!='1.4.0': errors.append(f'Unexpected VERSION: {version}')
...
if str(manifest.get('library_version'))!='1.4.0': errors.append('Manifest version mismatch')
...
if len(cases)!=30: errors.append(f'Expected 30 test cases, got {len(cases)}')
