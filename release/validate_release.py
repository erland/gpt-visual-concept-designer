...
if version!='1.2.0': errors.append(f'Unexpected VERSION: {version}')
...
if str(manifest.get('library_version'))!='1.2.0': errors.append('Manifest version mismatch')
...
if len(cases)!=22: errors.append(f'Expected 22 test cases, got {len(cases)}')
...
for req in ['README.md','INSTALLATION.md','USAGE.md','CHANGELOG.md','RELEASE-NOTES.md','release/PREFLIGHT-REPORT.md','workflow/project-bundle-workflow.md','schemas/project-manifest.schema.yaml','schemas/image-manifest.schema.yaml','workflow/project-manifest-guide.md']:
